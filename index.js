...
app.get('/', (req, res) => res.send('Bot đã OK rồi đó'))
...
client.on("ready", async () => {
  console.log(`Ê bro!Tôi dậy rồi nè`);
  client.user
    .setActivity(`Your-Activity`, { type: "PLAYING" })
...
modules.forEach(function(module) {
  fs.readdir(`./commands/${module}`, function(err, files) {
    ...
    files.forEach(function(file) {
      ...
      console.log(`${command.name} Đã tải xong lệnh!`);
